...
public class CalDAVRequestThreadLocal {
	...
	private static Log _log = LogFactoryUtil.getLog(CalDAVRequestThreadLocal.class);

	private static ThreadLocal<String> _content = new AutoResetThreadLocal<String>(
			CalDAVRequestThreadLocal.class + "._content");
	private static ThreadLocal<Document> _document = new AutoResetThreadLocal<Document>(
