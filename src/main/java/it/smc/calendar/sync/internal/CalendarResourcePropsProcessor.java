...
public class CalendarResourcePropsProcessor extends BasePropsProcessor {
	...
	public CalendarResourcePropsProcessor(WebDAVRequest webDAVRequest, Resource resource, Element rootElement) {
	...
	protected void processDAVCurrentUserPrivilegeSet() {
		...
		if (CalendarResourcePermission.contains(webDAVRequest.getPermissionChecker(), _calendarResource,
				ActionKeys.UPDATE)) {
	...
	protected void processDAVOwner() {
		DocUtil.add(successPropElement, CalDAVProps.DAV_OWNER,
