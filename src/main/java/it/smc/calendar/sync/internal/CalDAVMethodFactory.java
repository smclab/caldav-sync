...
import it.smc.calendar.sync.internal.methods.DeleteMethodImpl;
import it.smc.calendar.sync.internal.methods.GetMethodImpl;
import it.smc.calendar.sync.internal.methods.OptionsMethodImpl;
import it.smc.calendar.sync.internal.methods.PropfindMethodImpl;
import it.smc.calendar.sync.internal.methods.ProppatchMethodImpl;
import it.smc.calendar.sync.internal.methods.PutMethodImpl;
import it.smc.calendar.sync.internal.methods.ReportMethodImpl;
...
public class CalDAVMethodFactory implements MethodFactory {
	...
	public Method create(HttpServletRequest request) throws WebDAVException {
		...
		if (_log.isDebugEnabled()) {
			...
			sb.append(com.liferay.portal.kernel.util.PortalUtil.getCurrentCompleteURL(request));
