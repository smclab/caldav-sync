...
public class CalendarResourceImpl extends BaseResourceImpl {
	...
	public InputStream getContentAsStream() throws WebDAVException {
		try {
			String data = CalendarServiceUtil.exportCalendar(_calendar.getCalendarId(),
	...
	public long getSize() {
		...
		try {
			CalendarServiceUtil.exportCalendar(_calendar.getCalendarId(), CalendarDataFormat.ICAL.getValue());
		} catch (Exception e) {
			if (_log.isWarnEnabled()) {
				_log.warn("Unable to export calendar to ics for calendar " + _calendar.getCalendarId());
			}
		}
