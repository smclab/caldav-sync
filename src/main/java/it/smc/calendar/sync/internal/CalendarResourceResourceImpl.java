...
public class CalendarResourceResourceImpl extends BaseResourceImpl {
	...
	public CalendarResourceResourceImpl(CalendarResource calendarResource, String parentPath, Locale locale) {

		super(parentPath, StringPool.BLANK, calendarResource.getName(locale), calendarResource.getCreateDate(),
